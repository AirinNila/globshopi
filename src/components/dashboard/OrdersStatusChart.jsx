...
const data = [
  { name: "Returned", value: 42, color: "#8571F4" }, 
  { name: "Delivered", value: 68, color: "#C686F8" }, 
  { name: "Pending", value: 50, color: "#C686F866" }, 
];
...
export default function OrdersChart() {
  ...
  return (
    <div>
      ...
      {/* Content */}
      <CardContent className="w-full lg:h-[240px]  lg:flex items-center justify-between">
        {/* Donut Chart */}
