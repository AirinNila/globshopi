...
export default function Navbar() {
  ...
  return (
    <section className="shadow sticky top-0 z-50">
      <div className=" bg-white baseContainer">
        {/* Top Navigation */}
        <nav className="w-full sm:px-4 py-2 ">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative dropdown-container">
                <button
                  ...
                  className="flex flex-col justify-center items-center text-blue-500 cursor-pointer"
                >
                ...
                {/* Dropdown Menu */}
                {isDropdownOpen && (
                  <div className="absolute text-sm right-0 mt-2 w-48 bg-white border border-gray-200 rounded-md shadow-lg z-10">
                    <Link
                      href="/register"
        ...
        <div className="w-full bg-white">
          <div className="flex items-center justify-between px-1 md:px-4 py-3 -mt-2">
            ...
            {activeMobileTab === "profile" && (
              <ul className="flex flex-col gap-2 text-sm text-gray-700">
                <li className="p-2 rounded hover:bg-gray-100 cursor-pointer">
                  <Link href={"/register"}>Retailer Register</Link>
                </li>
                <li className="p-2 rounded hover:bg-gray-100 cursor-pointer">
