...
export default function ProductDetailsContents() {
  ...
  const buttonClass = (category) =>
    `px-8 py-1.5 border border-gray-300 rounded-full text-sm md:text-lg font-medium transition-all duration-200 cursor-pointer 
    ${
      filter === category
  ...
  return (
    <section className="py-10">
      <div className="baseContainer grid gap-10 overflow-hidden">
        {/* Filter buttons container */}
        <div className="flex flex-wrap justify-center border-t-gray-200 border-t pt-10 md:justify-start gap-1 md:gap-4">
    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="p-4 border-gray-200 border rounded-2xl flex flex-col gap-3">
        <div className="grid gap-3">
          ...
          <div className="text-sm md:text-md pb-4 ">
            <div className="flex md:grid md:grid-cols-3 md:pr-60 border-b border-gray-300 *:py-2">
              <span className="w-1/2 md:w-fit">Size</span>
              <span className="max-md:w-1/2 max-md:text-end">
                6.1‑inch (diagonal)
              </span>
            </div>
            <div className="flex md:grid md:grid-cols-3 md:pr-60 border-b border-gray-300 *:py-2">
              <span className="w-1/2 md:w-fit">Type</span>
              <span className="max-md:w-1/2 max-md:text-end">
                Super Retina XDR display all‑screen OLED display
              </span>
            </div>
            <div className="flex md:grid md:grid-cols-3 md:pr-60 border-b border-gray-300 *:py-2">
              <span className="w-1/2 md:w-fit">Resolution</span>
              <span className="max-md:w-1/2 max-md:text-end">
                2532‑by‑1170-pixel resolution at 460 ppi
              </span>
            </div>
            <div className="flex md:grid md:grid-cols-3 md:pr-60 border-b border-gray-300 *:py-2">
              <span className="w-1/2 md:w-fit">Brightness</span>
              <span className="max-md:w-1/2 max-md:text-end">
            ...
            <div className="flex md:grid md:grid-cols-3 md:pr-60 border-b border-gray-300 *:py-2">
              <span className="w-1/2 md:w-fit">Features</span>
              <span className="max-md:w-1/2 max-md:text-end">
                HDR display <br />
                True Tone <br />
                Wide color (P3) <br />
        ...
        <div className="grid gap-3">
          ...
          <div className="grid text-sm md:text-md pb-4 ">
            <div className="flex md:grid md:grid-cols-3 md:pr-60 border-b border-gray-300 *:py-2">
              <span className="w-1/2 md:w-fit">Chipset</span>
              <span className="max-md:w-1/2 max-md:text-end">A18 chip</span>
            </div>
            <div className="flex md:grid md:grid-cols-3 md:pr-60 border-b border-gray-300 *:py-2">
              <span className="w-1/2 md:w-fit">CPU Type</span>
              <span className="max-md:w-1/2 max-md:text-end">
                Super Retina XDR display {"all‑screen"} OLED display
              </span>
            </div>
...
const Questions = () => {
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="p-4 border-gray-200 border rounded-2xl flex flex-col gap-3">
        <div className="collapse collapse-arrow bg-base-100 border border-base-300 px-3">
          <input type="radio" name="my-accordion-2" defaultChecked />
          <div className="collapse-title font-semibold after:absolute after:right-[18px] border-b border-gray-200 px-0 py-2">
        ...
        >
          ...
          <div className="flex items-center justify-between text-gray-700 text-sm md:space-x-4 mt-auto">
            ...
            >
              ...
              <span className="text-end">Helpful!</span>
            </Link>
            <Link
              href={""}
              className="flex items-center justify-center md:space-x-1  md:p-2 rounded-lg hover:bg-gray-200 transition-colors duration-200"
            >
              ...
              <span className="text-end">Not Helpful!</span>
            </Link>
            <Link
              href={""}
