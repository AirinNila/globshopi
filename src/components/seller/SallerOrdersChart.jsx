...
const data = [
  { name: "Returned", value: 12, color: "#71BDF4" },
  { name: "Delivered", value: 98, color: "#B586F8" },
  { name: "Pending", value: 5, color: "#C686F866" },
];

const filterOptions = ["12 Months", "6 Months", "30 Days", "7 Days"];

export default function SallerOrdersChart() {
  ...
  return (
    <div className="mt-10">
      ...
      <Card className="lg:p-5  rounded-3xl  border border-[#D1D1D680] bg-white/80 backdrop-blur">
          ...
          <div className=" space-x-1 space-y-1">
            {filterOptions.map((option) => (
              <Button
                ...
                className={` border border-[#D1D1D680] rounded-full text-xs px-2 py-1 transition-all ${
                  filter === option
        ...
        {/* Content */}
        <CardContent className="w-full lg:h-[264]  lg:flex items-center justify-between">
          {/* Donut Chart */}
