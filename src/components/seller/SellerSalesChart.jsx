...
export function SellerSalesChart() {
  ...
  return (
    <div className="mt-10">
      <h3 className="text-2xl my-5 font-medium">Total Sales</h3>

      <Card className="border-[#D1D1D680] rounded-3xl">
        {/* Header */}
        <CardHeader className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-1">
          <h3 className="lg:text-lg lg:font-semibold  text-gray-700">
            Sales Report
          </h3>
          ...
          <div className="flex flex-wrap items-center gap-1">
            ...
            <Button className="flex items-center gap-2 bg-[#007AFF] text-white rounded-full  hover:bg-[#0066dd]">
        ...
        {/* Chart */}
        <CardContent className="w-full lg:h-[250px] h-auto">
          <ResponsiveContainer>
