      ...
      <div className="embla__viewport overflow-hidden" ref={emblaRef}>
        <div className="embla__container flex">
          {slides.map((e, index) => (
            ...
            >
              <Link
                href={"/products/iphone234"}
                className="transition-all duration-200 bg-white rounded-xl border-blue-200 border h-[190px] w-[130px] flex flex-col items-center justify-center hover:shadow-md hover:shadow-blue-300 hover:border-blue-500"
              >
